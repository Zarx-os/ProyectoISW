...
class Ansiedad : Fragment() {
    lateinit var btnAnsiedad: Button
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_ansiedad, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        btnAnsiedad = view.findViewById(R.id.btnAnsiedad)
        edtPregunta1 = view.findViewById(R.id.edtPregunta1)
        edtPregunta2 = view.findViewById(R.id.edtPregunta2)
        edtPregunta3 = view.findViewById(R.id.edtPregunta3)
        edtPregunta4 = view.findViewById(R.id.edtPregunta4)
        edtPregunta5 = view.findViewById(R.id.edtPregunta5)
        edtPregunta6 = view.findViewById(R.id.edtPregunta6)
        edtPregunta7 = view.findViewById(R.id.edtPregunta7)
        edtPregunta8 = view.findViewById(R.id.edtPregunta8)
        edtPregunta9 = view.findViewById(R.id.edtPregunta9)
        edtPregunta10 = view.findViewById(R.id.edtPregunta10)
        edtPregunta11 = view.findViewById(R.id.edtPregunta11)
        edtPregunta12 = view.findViewById(R.id.edtPregunta12)


        btnAnsiedad.setOnClickListener {
            ...
            if ((edtPregunta1.text.isEmpty() ||
                ...
                Toast.makeText(
                    this.context,
                    "No debes dejar vacio ningun campo",
                    Toast.LENGTH_SHORT
                ).show()
                ...
                if (prefs.getUser() == 0) {
                    prefs.saveVal(1)
                } else if (prefs.getUser() == 1) {
                    activity?.finish()
                }
            } else Toast.makeText(
                this.context,
                "Recuerda que cada solo es de 0 a 3",
                Toast.LENGTH_SHORT
            ).show()

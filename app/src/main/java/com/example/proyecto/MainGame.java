...
public class MainGame
{
                ...
                if (tile != null)
                {
                    ...
                    if (next != null && next.getValue() == tile.getValue() && next.getMergedFrom() == null)
                    {
                        ...
                        if(!MainMenuActivity.mIsMainMenu)
                        {
                            ...
                            {
                                GameActivity.unlockAchievement(merged.getValue());
    ...
    public void RemoveTilesWithTrash()
    {
        ...
        {
            if(GameActivity.mRewardDeletes > 0)
            {
                if(mView.game.grid.getAvailableCells().size() < cellCount)
                {
                    new AlertDialog.Builder(mView.getContext())
                            .setPositiveButton(R.string.yes_delete_tiles, new DialogInterface.OnClickListener()
                            {
                                ...
                                {
                                    GameActivity.mRewardDeletes--;  // decrease rewards
                                    customSaveLoadTemp();
                                    mView.invalidate();
                                }
                            })
    ...
    public void loadCurrentBoard()
    {
        ...
        GameActivity.mRewardDeletes = settings.getInt(REWARD_DELETES, 2);
    ...
    public void saveCurrentBoard()
    {
        ...
        // reward deletions:
        editor.putInt(REWARD_DELETES, GameActivity.mRewardDeletes);
